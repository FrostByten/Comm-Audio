...
public:
    ...
    void setupUi(QDialog *Settings)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(10, 90, 311, 41));
        ...
        gridLayout->addWidget(mic_port, 0, 5, 1, 1);

        gridLayoutWidget_2 = new QWidget(Settings);
        gridLayoutWidget_2->setObjectName(QStringLiteral("gridLayoutWidget_2"));
        gridLayoutWidget_2->setGeometry(QRect(10, 10, 271, 74));
        ...
        gridLayout_2->addWidget(control_ip, 2, 2, 1, 1);
    ...
    void retranslateUi(QDialog *Settings)
    {
        ...
        audio_ip->setText(QApplication::translate("Settings", "234.5.6.7", 0));
        control_ip->setText(QApplication::translate("Settings", "127.0.0.1", 0));
    } // retranslateUi
